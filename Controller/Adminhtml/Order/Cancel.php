    ...
    public function execute()
    {
            ...
            ->getCancellationCode()))
        {
           foreach($orders as $order)
           {
               ...
               $cancelResponse=$this->_objectManager->create('\Ced\GoodMarket\Helper\Data')->cancelOrder($shipmentData);
               $goodmarketOrder = $this->objectManager->create('Ced\GoodMarket\Model\Order')->load($order['magento_increment_id'], 'magento_increment_id');
